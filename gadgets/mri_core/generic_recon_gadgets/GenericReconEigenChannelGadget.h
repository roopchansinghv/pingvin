...
namespace Gadgetron {
    ...
    public:
        ...
        GenericReconEigenChannelGadget(const Core::Context &context, const Core::GadgetProperties &properties);
        ...
        NODE_PROPERTY(update_eigen_channel_coefficients, bool, "Whether to update KLT coefficients for eigen channel computation", false);
        ...
        NODE_PROPERTY(upstream_coil_compression, bool, "Whether to perform upstream coil compression", true);
        ...
        NODE_PROPERTY(upstream_coil_compression_thres, double, "Threadhold for upstream coil compression", -1);
        NODE_PROPERTY(upstream_coil_compression_num_modesKept, int, "Number of modes to keep for upstream coil compression", 0);
